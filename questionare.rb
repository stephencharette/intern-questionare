...
one = gets.chomp
print "Question #2: What is a *unique if possible* hobby that you enjoy? "
two = gets.chomp
...
four = gets.chomp
print "Question #5: Do you know any hidden gem dining/food places that you really enjoy? "
five = gets.chomp
print "Question #6: Have you ever been hiking before and if so where/which trail did you go hiking on? "
six = gets.chomp
print "Question #7: Roughly how long is your commute here? "
seven = gets.chomp 
print "Question #8: If you were able to work completely remote, where would you live and why? "
eight = gets.chomp
print "Question #9: What streaming service would you recommend? *excluding Hulu* "
nine = gets.chomp
